...
<head>
	...
	<link rel="stylesheet" href="css/style9-btn.css">
...
<body>
	...
	<div id="formularios">
		<form action="v9-recibir_post.php" id="form_session" method="post">
			...
			<p class="center-content">
				...
				<!-- <a href="v9-recibir_get.php?tipo_usuario=nuevo&navegador=chrome">Registra cuenta</a> -->
				<a href="v9-recibir_get.php?tipo_usuario=nuevo&navegador=brave">Registra cuenta</a>
			</p>
		</form>	
